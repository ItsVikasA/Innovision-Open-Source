...
export async function GET(request) {
  ...
  try {
    ...
    if (recSnap.exists) {
      ...
      if (
        now - (data.lastUpdated || 0) < oneWeek &&
        (!currentQuery || data.queryUsed === currentQuery)
      ) {
        return NextResponse.json({
          success: true,
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a smart educational counselor. Recommend specific courses or generate new roadmap ideas based on user history.",
        },
      ...
      recommendations = [
        {
          ...
          rationale: "A natural next step for your growth.",
          isIdea: true,
        },
        {
          id: "idea-ai-ml",
          title: "Artificial Intelligence Essentials",
          description: "Learn how to build AI-powered apps.",
          rationale: "Stay ahead in the tech landscape.",
          isIdea: true,
        },
      ];
    }
